      ...
      <section className="py-16 px-6 bg-[#0f0e0c]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-4">
            ...
            {/* WhatsApp card */}
            <div className="bg-[#141210] border border-[#c9a84c]/20 p-6 hover:border-[#c9a84c] transition-all duration-300">
            ...
            <div className="bg-[#141210] border border-[#c9a84c]/20 p-6">
