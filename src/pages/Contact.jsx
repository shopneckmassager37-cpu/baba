      ...
      <section className="py-16 px-6 bg-[#f5f0e8]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-4">
            ...
            {/* WhatsApp card */}
            <div className="bg-white border border-[#e0d8cc] p-6 hover:border-[#c9a84c] hover:shadow-md transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-[#1a1813] font-light text-base mb-1">WhatsApp</h3>
                  <p className="text-[#6b5f50] text-sm mb-3">Click to message our team directly</p>
            ...
            <div className="bg-white border border-[#e0d8cc] p-6 hover:border-[#c9a84c] hover:shadow-md transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[#1a1813] font-light text-base mb-1">Email</h3>
                  <p className="text-[#6b5f50] text-sm mb-3">Send us a detailed message</p>
            ...
            <div className="bg-white border border-[#e0d8cc] p-6">
              <h3 className="text-[#1a1813] font-light text-base mb-5">What Happens Next?</h3>
              {[
                ...
                <div key={i} className="flex items-start gap-4 mb-4 last:mb-0">
                  ...
                  <p className="text-[#6b5f50] text-sm font-light leading-relaxed">{step}</p>
                </div>
              ))}
            </div>
          ...
          <div className="bg-[#141210] border border-[#c9a84c]/20 p-8">
            {submitted ? (
