      ...
      <section className="py-16 px-6 bg-[#1c1b1a]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-4">
            <h2 className="text-xs tracking-[0.4em] text-[#c9a84c] mb-6">CONTACT OPTIONS</h2>

            {/* WhatsApp card */}
            <div className="bg-[#1d1d1d] border border-[#c9a84c]/15 p-6 hover:border-[#c9a84c]/35 transition-colors">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 border border-[#c9a84c]/30 flex items-center justify-center flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-[#c9a84c]">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-light text-base mb-1">WhatsApp</h3>
                  <p className="text-gray-500 text-sm mb-3">Click to message our team directly</p>
            ...
            <div className="bg-[#1d1d1d] border border-[#c9a84c]/15 p-6 hover:border-[#c9a84c]/35 transition-colors">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-light text-base mb-1">Email</h3>
                  <p className="text-gray-500 text-sm mb-3">Send us a detailed message</p>
            ...
            <div className="bg-[#1d1d1d] border border-[#c9a84c]/15 p-6">
              <h3 className="text-white font-light text-base mb-5">What Happens Next?</h3>
              {[
                ...
                <div key={i} className="flex items-start gap-4 mb-4 last:mb-0">
                  ...
                  <p className="text-gray-400 text-sm font-light leading-relaxed">{step}</p>
                </div>
              ))}
            </div>
          ...
          <div className="bg-[#1d1d1d] border border-[#c9a84c]/15 p-8">
            {submitted ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <label className="block text-xs text-gray-400 mb-1.5 tracking-widest">YOUR NAME *</label>
                    <input type="text" name="name" required value={form.name} onChange={handleChange}
                      className="w-full bg-[#252525] border border-[#333] text-white px-4 py-3.5 focus:outline-none focus:border-[#c9a84c]/60 transition-colors font-light text-sm placeholder-gray-600"
                      placeholder="Your full name" />
                  </div>
                  <div>
                    <label className="block text-xs text-gray-400 mb-1.5 tracking-widest">EMAIL ADDRESS *</label>
                    <input type="email" name="email" required value={form.email} onChange={handleChange}
                      className="w-full bg-[#252525] border border-[#333] text-white px-4 py-3.5 focus:outline-none focus:border-[#c9a84c]/60 transition-colors font-light text-sm placeholder-gray-600"
                      placeholder="your@email.com" />
                  </div>
                  <div>
                    <label className="block text-xs text-gray-400 mb-1.5 tracking-widest">YOUR MESSAGE *</label>
                    <textarea name="message" required rows={7} value={form.message} onChange={handleChange}
                      className="w-full bg-[#252525] border border-[#333] text-white px-4 py-3.5 focus:outline-none focus:border-[#c9a84c]/60 transition-colors font-light resize-none text-sm placeholder-gray-600"
                      placeholder="Tell us about your event — the occasion, the date, the destination, or simply how you're imagining it..." />
                  </div>
                  <button type="submit" disabled={loading}
                    className="w-full py-4 bg-[#c9a84c] text-black text-xs tracking-[0.3em] hover:bg-[#e0c070] transition-colors font-semibold disabled:opacity-60">
