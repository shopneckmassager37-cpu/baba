...
const TICKER_ITEMS = ["Weddings","Bar & Bat Mitzvahs","Fundraising Galas","Corporate Events","VIP Experiences","Milestone Celebrations","Sailing Events","Heritage Journeys","Destination Celebrations","Private Events"];

function Ticker() {
  const items = [...TICKER_ITEMS, ...TICKER_ITEMS];
  return (
    <div className="bg-[#c9a84c] py-3 overflow-hidden whitespace-nowrap" style={{ userSelect: "none" }}>
    ...
    <footer className="bg-[#111] border-t border-[#c9a84c]/15 pt-14 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 border border-[#c9a84c]/30 px-3 py-2 text-gray-400 hover:border-[#c9a84c] hover:text-[#c9a84c] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
        ...
        <div className="border-t border-[#c9a84c]/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-2">
          <p className="text-gray-500 text-xs tracking-wide">© 2025 Avicam Gitlin Private Events. All rights reserved.</p>
...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#161616] text-white" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
      ...
      {/* Hero — tighter, not full screen height */}
      <section className="relative flex items-center justify-center overflow-hidden" style={{ minHeight: "85vh" }}>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-[#161616]" />
      ...
      <section className="py-16 px-6 bg-[#161616]">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#c9a84c] tracking-[0.5em] text-xs mb-6">THE AVICAM GITLIN DIFFERENCE</p>
          ...
          <p className="text-gray-400 text-base font-light leading-relaxed max-w-2xl mx-auto">
            Over a decade producing bespoke private events across the world's most spectacular destinations. Unmatched expertise, impeccable discretion, and a deeply personal touch — every time.
          </p>
        </div>
      </section>

      {/* Event types — 3 col */}
      <section className="py-4 px-6 pb-16 bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
      ...
      <section className="py-16 px-6 bg-[#1a1a1a]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl font-light leading-tight mb-6">The person behind<br />every extraordinary event.</h2>
            <div className="w-10 h-px bg-[#c9a84c]/50 mb-6" />
            <p className="text-gray-400 font-light leading-relaxed mb-5">
              Avicam Gitlin is a private event producer with over 15 years of experience creating bespoke celebrations across the world's most spectacular destinations — from weddings in Tuscany to galas in New York.
            </p>
          ...
          <div className="relative">
            <img src={AVICAM} alt="Avicam Gitlin" className="w-full h-[440px] object-cover object-top"
            ...
            <div className="absolute bottom-4 left-4 bg-black/70 backdrop-blur-sm border border-[#c9a84c]/30 px-4 py-2">
              ...
              <p className="text-gray-400 text-xs mt-0.5">Private Events · Worldwide</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="relative py-24 px-6 text-center overflow-hidden" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1510076857177-7470076d4098?w=1920&q=80')", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="relative z-10 max-w-xl mx-auto">
          ...
          <p className="text-gray-300 font-light mb-8 text-base">Every extraordinary event starts with a conversation.</p>
