        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-gray-400 font-light leading-relaxed">
            {[
              ...
              <div key={i}>
                <h2 className="text-white text-lg font-light mb-3 tracking-wide">{s.title}</h2>
          ...
          <div className="mt-16 pt-8 border-t border-[#c9a84c]/15">
            <p className="text-gray-600 text-xs">Last updated: January 2025 · © 2025 Avicam Gitlin Private Events</p>
          </div>
        </div>
      </section>
